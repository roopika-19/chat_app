...
const renameGroup = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
const removeFromGroup = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
const addToGroup = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { chatId, userId } = req.body;
